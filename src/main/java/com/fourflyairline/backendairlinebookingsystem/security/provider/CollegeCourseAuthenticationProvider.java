package com.fourflyairline.backendairlinebookingsystem.security.provider;
...
@Component
@AllArgsConstructor
public class CollegeCourseAuthenticationProvider implements AuthenticationProvider {
